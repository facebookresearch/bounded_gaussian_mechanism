...
def main(cfg):
    ...
    # cfg.batch_size = len(train_images)
    ...
    np.savetxt(f'results/cifar_linf_clipping_rectification_subsample/ cifar_rec_sigma_{cfg.sigma: .4f}_lr_{cfg.step_size: .2f}_bound_{cfg.ub: .2f}_norm_{cfg.norm_clip: .4f}.txt', np.asarray([median_eta, max_eta, train_accuracy, test_accuracy]))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default="cnn_cifar", type=str,
        help="model used")
    ...
    parser.add_argument("--batch_size", default=200, type=int,
        help="batch size")
    parser.add_argument("--momentum_mass", default=0.5, type=float,
        help="momentum mass")
